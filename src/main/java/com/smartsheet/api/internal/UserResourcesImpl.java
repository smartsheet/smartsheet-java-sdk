...
public class UserResourcesImpl extends AbstractResources implements UserResources {
    ...
    public PagedResult<User> listUsers(Set<String> email, EnumSet<ListUserInclusion> includes,
                                       ...
                                       PaginationParameters pagination) throws SmartsheetException {
        return this.listUsersInternal(email, includes, planId, seatType, numericDates, pagination);
    }
    ...
    @Override
    public TokenPaginatedResult<UserPlan> listUserPlans(long userId) throws SmartsheetException {
        return this.listResourcesWithTokenPagination(USERS + "/" + userId + "/plans", UserPlan.class);
    }
