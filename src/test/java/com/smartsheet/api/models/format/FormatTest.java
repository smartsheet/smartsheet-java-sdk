...
class FormatTest {
    ...
    enum ParserTests {
        ...
        ;
        static final int EXPECTED_COUNT = 16;
        final String format;
        final int[] output;
    ...
    void testFormatBuilderVariousSettings() throws IOException {
        ...
        verifySerializedFormat(
                ",,,,,," + HorizontalAlignment.CENTER.ordinal() + ",,," + Color.ORANGE_4.ordinal() + ",," +
                        Currency.BRAZIL_REAIS.ordinal() + ",,," + NumberFormat.PERCENT.ordinal() + ",,",
                actual
        );
    }
