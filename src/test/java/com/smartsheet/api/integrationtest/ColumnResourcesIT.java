...
class ColumnResourcesIT extends ITResourcesImpl {
    ...
    public void testAddColumn() throws SmartsheetException, IOException {
        ...
        //add columns
        List<Column> addedColumns = smartsheet
                .sheetResources()
                .columnResources()
                .addColumns(newSheet.getId(), Arrays.asList(column1, column2, column3));
        assertThat(addedColumns).hasSize(3);
    }

    public void testGetColumn() throws SmartsheetException {
        Column newColumn = smartsheet
                .sheetResources()
                .columnResources()
                .getColumn(newSheet.getId(), addedColumn.getId(), EnumSet.allOf(ColumnInclusion.class));
    ...
    public void testListColumns() throws SmartsheetException {
        ...
        PagedResult<Column> wrapper = smartsheet
                .sheetResources()
                .columnResources()
                .listColumns(newSheet.getId(), EnumSet.allOf(ColumnInclusion.class), parameters);
